(() => {
  ...
  const reviewLoginCheckBox = document.querySelector("#reviewLogin");
  const emailInput = document.querySelector(".emailInput");
  const passwordInput = document.querySelector(".passwordInput");

  reviewLoginCheckBox.addEventListener("change", (e) => {
    if (e.target.checked) {
      emailInput.value = "ajmaljaleel7860@gmail.com";
      passwordInput.value = "ajmaljaleel";
    } else {
      emailInput.value = "";
      passwordInput.value = "";
    }
